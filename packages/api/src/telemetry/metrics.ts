...
export const analyticsEventsIngestedTotal = new Counter(
    'analytics_events_ingested_total',
    'Client analytics events successfully written to the warehouse'
);

export const analyticsEventsDroppedTotal = new Counter(
    'analytics_events_dropped_total',
    'Client analytics events dropped before reaching the warehouse',
    ['reason']
);
