...
export type PluginInstallStatus = 'enabled' | 'disabled' | 'available' | 'pending' | 'error';
...
export type CreatorSubscriptionStatus = 'pending' | 'active' | 'canceled' | 'refunded' | 'expired';
