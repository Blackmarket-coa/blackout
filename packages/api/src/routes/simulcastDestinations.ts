...
// broadcast panel lists destinations on mount alongside its siblings.
simulcast.use('/', integrationsRateLimit);
simulcast.use('/:id', integrationsRateLimit);
simulcast.use('/:id/enabled', integrationsRateLimit);
