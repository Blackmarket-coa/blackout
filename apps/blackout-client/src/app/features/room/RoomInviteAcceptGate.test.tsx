...
// (e.g. the canopy) reports `null` so the gate joins it. `joinRoom` records
// the order of room ids it was called with. `encrypted` toggles the room's
// encryption state event, and `crypto` stands in for the rust-crypto module
// used by the key-recovery phase.
