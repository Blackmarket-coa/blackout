...
import { MEGOLM_ALGORITHM } from '../../../utils/matrix-crypto';
import { RoomPermissionsAPI } from '../../../hooks/useRoomPermissions';

const ROOM_ENC_ALGO = MEGOLM_ALGORITHM;
                ...
                after={
                    enabled ? (
                        ...
                        <Button
                            ...
                            before={
                                enabling && <Spinner size="100" variant="Primary" fill="Solid" />
                            }
                        >
                        ...
                        <OverlayCenter>
                            ...
                            >
                                <Dialog variant="Surface">
                                    ...
                                    >
                                        <Text priority="400">
                                            Are you sure? Once enabled, encryption cannot be
                                            disabled!
                                        </Text>
                                        <Button
                                            type="submit"
