...
export const DeadDropIndicator = ({ config, queueCount }: { config: DeadDropConfig; queueCount: number }) => {
  ...
  return (
    ...
    >
      ...
      <span style={{ opacity: 0.9 }}>
        Next delivery:{' '}
        {nextDelivery ? formatCountdown(nextDelivery) : 'manual trigger'}
      </span>
      <span style={{ border: '1px solid var(--border-default)', borderRadius: 999, padding: '2px 8px' }}>Queue: {queueCount}</span>
    </aside>
  );
};
