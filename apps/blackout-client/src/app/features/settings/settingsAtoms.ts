...
export const developerSettingsAtom = atomWithStorage<DeveloperSettingsState>('blackout.settings.developer.v1', { diagnosticsEnabled: false, includeLocalStorageInBundle: true, includeFeatureFlagsInBundle: true, creatorStudioEnabled: true, signingKeyId: null }, createSafeJsonStorage<DeveloperSettingsState>(), getOnInit);
