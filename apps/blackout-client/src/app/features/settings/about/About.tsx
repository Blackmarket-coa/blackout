...
// public/ is not Vite's publicDir here (publicDir: false); it is served and
// copied verbatim by vite-plugin-static-copy, whose dev middleware answers
// module requests (?import/?url) with the raw SVG and breaks the dev boot.
// Reference it by URL instead, like index.html does for the sibling icons.
const BrandSVG = `${import.meta.env.BASE_URL}public/res/svg/blackout.svg`;
                            ...
                            <Box gap="400">
                                ...
                                <Box direction="Column" gap="300">
                                    <Box direction="Column" gap="100">
                                        ...
                                        <Text>
                                            A modern Matrix client shaped around the Blackout
                                            runtime.
                                        </Text>
                                    </Box>
