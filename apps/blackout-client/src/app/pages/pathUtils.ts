...
import {
    ...
    MONETIZATION_QUESTS_PATH,
    MONETIZATION_SUBSCRIPTIONS_PLANS_PATH,
    MONETIZATION_THEME_PACKS_PATH,
} from './paths';
...
export const getMonetizationPath = (): string => MONETIZATION_PATH;
export const getMonetizationSubscriptionsPlansPath = (): string =>
    MONETIZATION_SUBSCRIPTIONS_PLANS_PATH;
export const getMonetizationBoostsPath = (): string => MONETIZATION_BOOSTS_PATH;
export const getMonetizationQuestsPath = (): string => MONETIZATION_QUESTS_PATH;
export const getMonetizationMarketplacePath = (): string => MONETIZATION_MARKETPLACE_PATH;
export const getMonetizationAppMarketplacePath = (): string => MONETIZATION_APP_MARKETPLACE_PATH;
