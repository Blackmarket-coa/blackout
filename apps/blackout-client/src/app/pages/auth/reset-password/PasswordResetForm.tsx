        ...
        <FocusTrap>
          <Dialog>
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Text>Password has been reset successfully. Please sign in with your new password.</Text>
...
export function PasswordResetForm({ defaultEmail }: PasswordResetFormProps) {
  ...
  }, [flowErrorCode, formData, handleResetPassword, ongoingAuthData]);
  ...
  const handleSubmitRequest = useCallback(
    (authDict: AuthDict) => {
      if (!formData) return;
      handleResetPassword(authDict, formData.password);
    },
