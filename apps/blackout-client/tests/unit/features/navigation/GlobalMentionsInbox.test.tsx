...
import { roomJumpTargetEventIdAtom, selectedRoomIdAtom } from '../../../../src/app/state/navigation';
...
describe('GlobalMentionsInbox integration', () => {
  it('routes mention click through openMentionItem to room switch + jump + receipt', async () => {
    ...
    const mentionButton = Array.from(container.querySelectorAll('button')).find((button) => button.textContent?.includes('hello')) as HTMLButtonElement;
