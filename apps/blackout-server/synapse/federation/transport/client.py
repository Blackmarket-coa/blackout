...
class TransportLayerClient:
    ...
    async def backfill(
        ...
        if not event_tuples:
            # Follow-up (owner: federation, rationale: consider raising a typed exception here instead of returning a sentinel failure result).
            return None
    ...
    async def send_transaction(
        ...
        # Follow-up (owner: federation, rationale: transport payload shape is test-only here): This is only used by the tests. The actual json sent is
