...
| Solarpunk theme | P1 | Complete | Theme catalog + canonical IDs are wired and covered by `theme-parity` tests in `apps/blackout-web/tests/unit/theme-parity.test.ts`. |
