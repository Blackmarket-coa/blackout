...
## Regenerated next top-10 P2 burn-down queue (2026-03-18 refresh)

| Rank | Marker | Owner | Milestone | Status |
| --- | --- | --- | --- | --- |
| 1 | `src/components/views/room_settings/RoomProfileSettings.tsx` L53/L141 | Room Settings | 2026.03 | Complete (2026-03-18) |
| 2 | `src/components/views/rooms/BasicMessageComposer.tsx` L751 | Composer | 2026.03 | Complete (2026-03-18) |
| 3 | `src/components/views/rooms/LegacyRoomList.tsx` L433 | Rooms Navigation | 2026.03 | Complete (2026-03-18) |
| 4 | `src/components/views/rooms/RoomSublist.tsx` L86 | Rooms UX | 2026.03 | Complete (2026-03-18) |
| 5 | `src/components/views/rooms/RoomTile.tsx` L298 | Notifications UX | 2026.03 | Complete (2026-03-18) |
| 6 | `src/components/views/settings/ChangePassword.tsx` L241 | Security UX | 2026.03 | Complete (2026-03-18) |
| 7 | `src/components/views/settings/tabs/room/BridgeSettingsTab.tsx` L61/L83 | Integrations | 2026.03 | Complete (2026-03-18) |
| 8 | `src/components/views/settings/tabs/user/AccountUserSettingsTab.tsx` L151/L160 | Account Settings | 2026.03 | Complete (2026-03-18) |
| 9 | `src/device-listener/DeviceListenerOtherDevices.ts` L86/L121 | E2EE Device Mgmt | 2026.03 | Complete (2026-03-18) |
| 10 | `src/integrations/IntegrationManagers.ts` L84 | Integrations Session Mgmt | 2026.03 | Complete (2026-03-18) |
