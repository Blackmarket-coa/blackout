...
- **Status (2026-04-30): foundation landed; UI rewire pending.**
  ...
  - Remaining acceptance work: render the actual channel manager + composer + lifecycle controls (canonical components are placeholders) and wire them into the canonical Cinny shell once BKL-001/002's UI rewire lands. End-to-end create → post → rotate → expire smoke test deferred to that follow-up.
...
- **Status (2026-04-30): foundation landed; settings IA rewire pending.**
  ...
  - Remaining acceptance work: actually render the preferences/sidebar/labs tabs against the SDK + atomWithStorage (canonical components are placeholders) and wire them into the canonical Cinny settings IA. End-to-end navigation smoke deferred to that follow-up.
...
- **Status (2026-04-30): foundation landed; settings IA rewire pending.**
  ...
  - Remaining acceptance work: render the actual mjolnir tab UI (banlist editor, subscription list, protection toggles) against the SDK and wire it into the canonical settings IA shared with BKL-007. Integration tests for protection status refresh deferred to that follow-up.
- **Dependencies:** BKL-002.
